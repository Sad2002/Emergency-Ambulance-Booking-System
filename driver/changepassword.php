...
if(!isset($error))
{
    ...
    $password = password_hash($password,PASSWORD_BCRYPT,$options);
     ...
     $result = mysqli_query($conn,"UPDATE driver SET password='$password' WHERE email='$email'");
           if($result)
           {
     ...
     <form method="post" enctype='multipart/form-data' action="">
      ...
      <div class="form-group">
             ...
             <label class="label_txt">Confirm New Password:-</label>
                ...
                <center>
<button  class="btn btn-success" name="change_password">Change Password</button><br><br>
<center><a href="driverdashboard.php" class="btn4 btn-secondary">Back</a></center>
</center>
            </div>
           </div>
       </form>
