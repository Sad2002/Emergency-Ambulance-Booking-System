...
$row = mysqli_fetch_assoc($res);
    ...
    $password = password_hash($password,PASSWORD_BCRYPT,$options);
            ...
            $result = mysqli_query($conn,"INSERT into driver(fname,lname,username,email,password,date) values('$fname','$lname','$username','$email','$password','$date')");
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</h5></button>
   <p>Have an account?  <a href="driverlogin.php">Log in</a> </p>
</form>
<?php } ?> 
</div>
		</div>
