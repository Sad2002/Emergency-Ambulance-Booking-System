...
<div class="container">
 ...
 <h2>MY PROFILE</h2><br>
  ...
  <p> Welcome! <span style="color:#33CC00"><?php echo $username; ?></span> </p>
            ...
            <div class="col"><a href="logout.php"><button type="button" class="btn1 btn-primary"><h5>Logout<h5></button></a>
          ...
          <tr>
           ...
           <div class="row">
            <div class="col-sm-2">
             ...
             <div class="col-sm-4">
                <a href="edit-profile.php"><button type="button" class="btn btn-primary"><h5>Edit Profile<h5></button></a>
            </div>
            <div class="col-sm-6">
         <a href="change-password.php"><button type="button" class="btn btn-warning"><h5>Change Password<h5></button></a>
            </div>
           </div>
        </div>
        <div class="col-sm-3">
