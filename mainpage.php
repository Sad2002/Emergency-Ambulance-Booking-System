...
<section class="header">
   ...
   <ul>
        ...
        <li> <a href="login.php"><i class="fa fa-lock" aria-hidden="true"></i>  Patient Login</a></li>
        <li><a href="driver/driverlogin.php"><i class="fa fa-lock" aria-hidden="true"></i>   Driver Login</a></li>
